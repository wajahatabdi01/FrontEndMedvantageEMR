...
export default function PatientData (){
    ...
    let parameterList = [
        ...
        { id: 16, parameterName: "Immunizations",apiParamName:"procedures" },
    ...
    return (
        <>
        <Navbar/>
            <section className="main-content_  pt-3 about-us12" style={{minHeight:'53vh'}}>
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12">
                            <div className="med-box">
                                <div className="title">Export Patient Data (USCDI-Data)</div>
