...
import GetAllSurgeryIssueList from '../../../API/GET/GetAllSurgeryIssueList';

const Surgery = ({issueDetailss, issueDetailsData, id}) => {
            ...
            <div className='problemhead'>
                <div className='problemhead-inn'>
                    <div className="col-12 mb-2">
                        <div>
                            <select className='form-control' id='ddlSurgery' name='titleId' style={{ height: '8em' }} multiple onChange={handleSelectSurgery}>
