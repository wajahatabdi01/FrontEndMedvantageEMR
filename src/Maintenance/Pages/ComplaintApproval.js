...
import GetAllComplaintStatusMaster from "../API/Complaint Status Master/GetAllComplaintStatusMaster";
...
import GetAccessName from "../../BMS Services/API/Device Access Control/GetAccessName";
import PostComplaintStatus from "../API/Complaint Status/PostComplaintStatus";
          ...
          <div className="row">
            <div className="col-12">
              <div className="med-box">
                <div className="title"> Complaint Approval
                </div>
                  ...
                  <div className='row'>
                    <div className='col-md-12 col-sm-12 col-xs-12 mb-3'>
                      ...
                      <div className="col-md-12 col-sm-12 col-xs-12 mb-3 me-2" style={{ width: '200px' }}>
                          <label htmlFor="ddlequipment" className="form-label">Complaint Approval<span className="starMandatory">*</span></label>
                          <select value={Complaint} name="ComplaintApproval" className="form-select form-select-sm" id='Complaint' aria-label=".form-select-sm example" onChange={handleOnChange}>
