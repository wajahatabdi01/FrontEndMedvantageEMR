...
import GetOccurenceFile from "../../Api/FHIRMasterAPI/ClassificationType/GetOccurenceFile";
import { useEffect, useState } from "react"
import GetClassificationFile from "../../Api/FHIRMasterAPI/ClassificationType/GetClassificationFile";
...
function Occurence() {
  ...
  let[sendForm,setSendForm] = useState({
     ...
     const getOccurence = async()=> {
        let response = await GetOccurenceFile();
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="med-box">
                                <div className="title">{t("OccurenceType")}</div>
                        ...
                        <div className="col-12 mt-1">
                            ...
                            <div className="med-table-section" style={{ "height": "74vh" }}>
                                <table className="med-table border_ striped">
                                    ...
                                    <tbody>
                                        {occurenceList && occurenceList.filter((val) => `${val.name}`.toLowerCase().includes(searchTerm.toLowerCase())).map((key, index) => {
                                            return (
                                                <tr>
