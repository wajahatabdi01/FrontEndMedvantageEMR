                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="med-box">
                                <div className="title">{t("ClassificationMaster")}</div>
                        ...
                        <div className="col-12 mt-1">
                            ...
                            <div className="med-table-section" style={{ "height": "74vh" }}>
                                <table className="med-table border_ striped">
                                    ...
                                    <tbody>
                                        {classificationList && classificationList.filter((val) => `${val.name}`.toLowerCase().includes(searchTerm.toLowerCase())).map((key, index) => {
                                            return (
                                                <tr>
