...
import GetAllBodyOrgan from '../../Api/OrganDepartmentMapping/GetAllBodyOrgan'

export default function OrganDepartmentMapping() {
    ...
    let getdata = async () => {
        ...
        let getOrgan = await GetAllBodyOrgan();
        ...
        if (getResponse.status === 1) {
            ...
            setOrganList(getOrgan.responseValue)
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-12">
                            <Heading text={t("Organ Department Mapping")} />
                            <BoxContainer>
                                <div className="mb-2 me-2">
                                    <label htmlFor="wardID" className="form-label">{t("Organ")} <span className="starMandatory">*</span></label>
                                    {organList && <DropdownWithSearch defaulNname={t("Select organ")} name="wardID" list={organList} valueName="id" displayName="regionName" editdata={editOrgan} getvalue={handleChange} clear={clearDropdown} clearFun={handleClear} />}
                                </div>
                                <div className="mb-2 me-2">
                        ...
                        <div className="col-12 mt-3">
                            <div className='handlser'>
                                <Heading text={t("Organ Department Mapping List")} />
