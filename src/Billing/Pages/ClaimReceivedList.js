...
import GetReceivedClaimList from '../API/GetReceivedClaimList';



export default function ClaimReceivedList() {
  ...
  const GetClaimReceivedList = async()=>{
    let List = await GetReceivedClaimList(FromDate , ToDate)
    if(List.status===1){
      setbillReport(List.responseValue)
          ...
          <div className="row">
            <div className="col-12">
              <div className="med-box">
                <div className="title">Claim Received List</div>
                      ...
                      {showUnderProcess === 1 ? <><TosterUnderProcess />  </> :
                        showToster === 1 ? <Toster value={tosterValue} message={tosterMessage} />
                          ...
                          <div>
                              ...
                              <button type="button" className="btn btn-save btn-save-fill btn-sm mb-1 me-1" onClick = {GetClaimReceivedList} ><i class="bi bi-search mx-2"></i>Get Details</button>
