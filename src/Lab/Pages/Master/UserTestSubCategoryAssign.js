...
import GetUserTestSubCategoryAssign from '../../Api/UserTestSubCategoryAssign/GetUserTestSubCategoryAssign'
import GetSubCategoryMaster from '../../Api/SubCategoryMaster/GetSubCategoryMaster'
import DeleteUserTestSubCategoryAssign from '../../Api/UserTestSubCategoryAssign/DeleteUserTestSubCategoryAssign'
import ValidationUserTestSubCategory from '../../../Validation/LabService/ValidationUserTestSubCategory'
import PutUserTestSubCategoryAssign from '../../Api/UserTestSubCategoryAssign/PutUserTestSubCategoryAssign'
import PostUserTestSubCategoryAssign from '../../Api/UserTestSubCategoryAssign/PostUserTestSubCategoryAssign'
...
export default function UserTestSubCategoryAssign() {
    let [subCategoryUserAssignList, setSubCategoryUserAssignList] = useState([])
    let [testSubCategoryList, setTestSubCategoryList] = useState([])
    ...
    let saveForm = async () => {
        ...
        if (valresponse) {
            ...
            let response = await PostUserTestSubCategoryAssign(sendForm.subCategoryID, sendForm.labuserId,userID,clientID   );
    ...
    //Get data
    let getdata = async () => {
        let getResponse = await GetUserTestSubCategoryAssign(clientID);
        let getSubCategory = await GetSubCategoryMaster();
        let getUser = await GetLabUser(clientID);


        
            setSubCategoryUserAssignList(getResponse.responseValue)
            setTestSubCategoryList(getSubCategory.responseValue)
    ...
    let handleDeleteRow = async () => {
        // setLoder(1)
        setShowUnderProcess(1)
        let response = await DeleteUserTestSubCategoryAssign(rowId)
        if (response.status === 1) {
            setShowUnderProcess(0)
            setShowToster(1)
        ...
        <>
            <section className="main-content mt-5 pt-3">
                <div className="container-fluid">
                    <div className="row">
                    <div class="col-12"><div class="med-box  mb-1"><div class="title">{t("User_Test_Sub_Category_Assign")}</div></div></div>
                        <div className="col-12">
                         <div class="inner-content">
                           <div className='dflex regEqualColums whitebg paddingcustom twocol'>
                                <div className="col-2 mb-2 me-2">
                                    <label htmlFor="subCategoryID" className="form-label">{t("Test_Sub_Category")} <span className="starMandatory">*</span></label>
                        ...
                        <div className="col-12 mt-1">
                            <Heading text={t("User_Test_Sub_Category_List")} />
                                                ...
                                                <tr key={val.id}>
                                                    ...
                                                    <td>
                                                        <div className="action-button">
                                                            <div data-bs-toggle="tooltip" data-bs-title="Edit Row" data-bs-placement="bottom"><img src={editBtnIcon} className='' alt='' onClick={() => { handleUpdate(val.id, val.subCategoryID, val.labuserId, val.UserId) }}/></div>
