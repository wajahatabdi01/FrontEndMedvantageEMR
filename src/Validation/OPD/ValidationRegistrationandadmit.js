function ValidationRegistrationandadmit (ptMob="",ptName="",ptAddress="",state='0',city='0',dob="",age="",gender='0',patientHeight='',patientWeight='',department='0',doctor='0', ward='0',bed="0" ){
...
export default ValidationRegistrationandadmit;