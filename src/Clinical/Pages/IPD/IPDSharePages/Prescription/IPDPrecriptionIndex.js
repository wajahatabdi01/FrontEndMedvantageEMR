...
export default function IPDPrecriptionIndex(props) {
  ...
  const getPatientVisit = async () => {
    ...
    if (resVisit.status === 1) {
      ...
      console.log(
        "resVisit.responseValue[0].encounterId : ",
        resVisit.responseValue[0].encounterId
      );
    ...
    <>
      <div className=" row">
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  {theEncounterId &&
                    theEncounterId.map((list, ind) => (
                      <option key={ind} value={list.encounterId}>
                        {list.visitDate}
                      </option>
                    ))}
                </select>
        ...
        <div className="col-md-9 col-sm-12 plt">
          <IPDTopVitals
            theEncounterId={toPassEncounter}
            toRefreshComponent={toRefreshComponent}
          />
