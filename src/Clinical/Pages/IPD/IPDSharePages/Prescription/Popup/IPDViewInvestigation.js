...
export default function IPDViewInvestigation(props) {
    ...
    let setData = () => {
        ...
        //     // response.push(val)
        // })
        setShowInvestigation([...tempdata])
        setSearchShow([...tempdata])
        setTotal(total)
            ...
            <div className="offcanvas-body " >
                <div className='p-0 boxcontainer'>
                    ...
                    <div className='toal-invest-in'>
                        ...
                        {/* <div className='toal-invest'>
                            <button type="button" className="btn btn-save-fill"> <img src={send} className='icnn' alt='' /> Send</button>
                        </div>
                        <div className='toal-invest'>
