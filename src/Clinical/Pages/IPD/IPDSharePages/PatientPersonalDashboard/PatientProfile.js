...
export default function PatientProfile() {
  ...
  return (
    <>
      ...
      <div className='d-flex justify-content-end mb-1 me-2'>
        {
          showBodyParts === 1 ?
            <div onClick={() => { setShowBodyParts(0) }}>             
              <button type="button" class="btn btn-save-fill btn-sm">Personal Dashboard</button>              
            </div> 
            :
            <div onClick={() => { setShowBodyParts(1) }}>            
              <button type="button" class="btn btn-save-fill btn-sm">Virtual View</button>              
            </div>
        }
      </div>
          ...
          <div className="p1-in">
            <div className="p1 wt">
              ...
              <div className='medica'>
                ...
                <div className='medica-in' style={{ minHeight: '430px' }}>
            ...
            <div className="p2 wt">
              ...
              <div className='whitebg' style={{ height: '408px', overflow: 'auto' }}>
              ...
              <div className='whitebg' style={{ height: '430px', overflow: 'auto' }}>
                <div className='didp_d'>
