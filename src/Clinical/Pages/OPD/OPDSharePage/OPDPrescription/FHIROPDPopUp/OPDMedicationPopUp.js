                ...
                <div className='col-12'>
                    <div className="row">
                        <div className="col-6 mb-2">
                            ...
                            <input type="date" min={getCurrentDate()} value={medicationData.beginDateTime} className="form-control form-control-sm" id="beginDateTime" name='beginDateTime' onChange={handleIssueDetailsChange} />
