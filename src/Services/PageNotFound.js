                ...
                <div className='d-flex justify-content-center align-items-center' style={{ height: "90vh" }}>
                    <div className='d-flex flex-column gap-2'>
                        ...
                        <div className='d-flex flex-column justify-content-center align-items-center gap-2' >
                            ...
                            <button onClick={()=>{history(-1)}} className='text-white' style={{ width: "151px", height: "38px", borderRadius: "5px", font: "normal normal medium 16px/25px Poppins", background: "#1D4999 0% 0% no-repeat padding-box", border: "none" }}>
                                Go Back Home
                            </button>
                        </div>
                    </div>
