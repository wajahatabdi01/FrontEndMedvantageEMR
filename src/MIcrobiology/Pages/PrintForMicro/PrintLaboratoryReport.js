...
export default function PrintLaboratoryReport() {
  ...
  let viewReportFun = () => {
    ...
    if (tempArr.length > 0) {
      ...
      navigate('/viewprintlaboratoryreport/');
    }
    else {
  ...
  useEffect(() => {
    getBillListForPrint(isDuplicate,3)
  },[])
  return (
    <>
      <section className="main-content mt-5 pt-3">
        <div className="container-fluid">
            <div className='row'>
             <div class="col-12"><div class="med-box  mb-1"><div class="title">{t("Laboratory_Report")}</div></div></div>
              <div className="col-md-8 col-sm-12 plt1">
                ...
                <div className='whitebg mt-1' style={{padding:"5px 0px 2px"}}>
                  ...
                  <div className="med-table-section shadow-none" style={{height: "75vh", position:'relative' }}>
              ...
              <div className="col-md-4 col-sm-12 prt1">
                <div className='whitebg' style={{height:'88vh', paddingTop:'0px'}}>
                  <div className='titile-txt'>
                  ...
                  <div className="med-table-section shadow-none" style={{ "height": "78vh",'box-shadow':'none' }}>
                    <TableContainer>
                      <thead>
                        <tr>
                      ...
                      <tbody>
                        {getTestResultList && getTestResultList.map((resultList, index) => {
                          ...
                          return (
                            <>
                              <tr>
                                {(resultList.isPrinted === 0 && isDuplicate === 0 && resultList.categoryID === 2 && eyeClicked === true) && <>
                                  ...
                                  <td>{t("Ready")}</td></>}
                                {(resultList.isPrinted === 1 && isDuplicate === 1 && resultList.categoryID === 2 && eyeClicked === true) && <>
                                  <td > <input type="checkbox" id={'checkSubTest' + resultList.testID} defaultChecked={isChecked} role='switch' /></td>
                                  <td>{resultList.testname}</td>
                                  <td>{t("Ready")}</td></>}
                              </tr>
