...
import PostItemCategoryMaster from '../API/ItemCategoryMaster/PostItemCategoryMaster';
import GetItemCatgoryMaster from '../API/ItemCategoryMaster/GetItemCatgoryMaster';
import PutItemCategoryMaster from '../API/ItemCategoryMaster/PutItemCategoryMaster';
import DeleteItemCategoryMaster from '../API/ItemCategoryMaster/DeleteItemCategoryMaster';
 ...
 document.body.dir = i18n.dir();
  ...
  const handleSave = async () => {
    ...
    // }
      ...
      let data = await PostItemCategoryMaster(obj);
      if (data.status === 1) {
        setShowUnderProcess(0);
        setTosterValue(0);
        setShowToster(1);
        setTosterMessage("Data Saved Successfully!");
        getItemCatgoryMaster();
  ...
  const getItemCatgoryMaster = async () => {
    setShowLoder(1);
  ...
  const handleUpdate = async () => {
    ...
    // }
      ...
      let data = await PutItemCategoryMaster(obj);
      if (data.status === 1) {
        setShowUnderProcess(0);
        setTosterValue(0);
        setShowToster(1);
  ...
  let deleteRow = async () => {
    ...
    let data = await DeleteItemCategoryMaster(obj);
          ...
          <div className="row">
            <div className="col-12">
              <div className="med-box">
                <div className="title">{t("Item_Category_Master")}</div>
                    ...
                    <div className='col-md-12 col-sm-12 col-xs-12 mb-3'>
                      <div className="d-flex flex-wrap align-content-end">
                        ...
                        <div className="col-md-4 col-sm-12 col-xs-12 mb-2 me-2">
                          <label htmlFor="Code" className="form-label">{t("Remark")}</label>
